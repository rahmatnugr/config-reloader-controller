...
IMG ?= ghcr.io/rahmatnugr/config-reloader-controller:latest
...
helm-uninstall: ## Uninstall Helm chart
	helm uninstall config-reloader-controller -n default
...
docker-buildx: ## Build and push docker image for the manager for cross-platform support
	...
	- $(CONTAINER_TOOL) buildx create --name config-reloader-controller-builder
	$(CONTAINER_TOOL) buildx use config-reloader-controller-builder
	- $(CONTAINER_TOOL) buildx build --push --platform=$(PLATFORMS) --tag ${IMG} -f Dockerfile.cross .
	- $(CONTAINER_TOOL) buildx rm config-reloader-controller-builder
	rm Dockerfile.cross
